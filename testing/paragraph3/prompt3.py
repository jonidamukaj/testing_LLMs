...
# Prompt templates
prompt_template1 = "Please describe briefly the following scientific author and consider the following information:\n\nName: {name}\nFirst joint author: {first_co_author}\nFirst joint Author Year: {first_co_author_year}\nFirst joint author Publication:{first_co_author_publications}\second joint author: {second_co_author}\second joint author Year: {second_co_author_year}\nsecond joint author Publication:{second_co_author_publications}\Another joint author: {another_co_author}\another joint Author Year: {another_co_author_year}\another joint author Publication:{another_co_author_publications}\nFirst Collaboration: {first_collaboration}\n\nFirst Collaboration Field: {first_collaboration_field}\nFirst Collaboration Paper number: {first_collaboration_papers}\n\nSecond Collaboration: {second_collaboration}\nSecond Collaboration Paper number: {second_collaboration_papers}\n\n"
